...
export class OptionsComponent implements OnInit, AfterViewInit {
  ...
  translateLocales: string[] = ['ar','az','bal','be','befr','bn','br','ca','cs','cy','da','de','el','en','engb','enin','enintl','enus','eo','es','esmx','et','eu','fi','fr','frca','fy','gl','gos','hi','hu','ia','id','it','ja','jbo','ka','kab','ko','ku','la','lt','mr','ms','nds','nl','oc','pl','pt','ptbr','ro','ru','sk','sr','sv','tl','tr','uk','uz','vi','zhcn','zza'];
