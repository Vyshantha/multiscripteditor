...
export class CustomiseKeyboardsComponent implements OnInit {
  ...
  fontsSources: string[] = ['chrs','dogr','elym','gong','gonm','hmnp','khar','khud','kult','luw','maka','moss','nshu','ougr','sgnw','sog','soyo','txg','ur','yezi','zanb'];
