...
export class CustomiseKeyboardsComponent implements OnInit {
  ...
  calculatorLayout: any = [
    ...
    {"row":[
      {"value":"′","action":"char","type":"arcminute","visible":"hide"},{"value":"cos","action":"char","type":"cosineFunc"},{"value":"cos⁻ⁱ","action":"char","type":"cosineInverseFunc","visible":"show"},{"value":"log","action":"char","type":"logarithm"},{"value":"10ˣ","action":"char","type":"powerOf10"},{"value":"≥","action":"char","type":"greaterThanEquals","visible":"hide"},{"value":">>","action":"char","type":"rightShift","visible":"hide"},{"value":"|","action":"char","type":"logicalOr","visible":"hide"},{"value":" ","type":"num4","action":"char","visible":"hide"},{"value":" ","type":"num5","action":"char","visible":"hide"},{"value":" ","type":"num6","action":"char","visible":"hide"},{"value":"*","action":"char","type":"multiplicationOp"},{"value":"·","action":"char","type":"multiplicationOp"},{"value":"×","action":"char","type":"multiplicationOp"}
    ]},
    {"row":[
      ...
      default :
        switch (type) {
          ...
          case 'base2' : // Binary
            ...
            this.calculatorLayout = [
              {"row":[
                {"value":"x₂","action":"char","type":"base2","visible":"hide"},{"value":"x₈","action":"char","type":"base8","visible":"hide"},{"value":"x₁₀","action":"char","type":"base10","visible":"hide"},{"value":"x₁₂","action":"char","type":"base12","visible":"hide"},{"value":"x₁₆","action":"char","type":"base16","visible":"hide"},{"value":"x₂₀","action":"char","type":"base20","visible":"hide"},{"value":"x₆₀","action":"char","type":"base60","visible":"hide"},{"value":"‰","action":"char","type":"partsPerMillion","visible":"hide"},{"value":"%","action":"char","type":"modulusOp","visible":"hide"},{"value":"𝑓+","action":"char","type":"functionKeyActivate","visible":"hide"},{"value":"𝑓+","action":"char","type":"functionKeyActivate","visible":"hide"},{"value":"🧠","action":"char","type":"useMemory"},{"value":"⎌","action":"char","type":"undoAction"},{"value":"⭕","action":"char","type":"restart"}
              ]},
              {"row": [
              ...
              {"row":[
                {"value":"★","action":"char","type":"bookmarkEquation"},{"value":this.currencySymbol,"action":"char","type":"currencySymbol","visible":"hide"},{"value":"x!","action":"char","type":"factorial","visible":"hide"},{"value":"ʸ√x","action":"char","type":"nthRoot","visible":"hide"},{"value":"∛","action":"char","type":"cubeRoot","visible":"hide"},{"value":"√","action":"char","type":"squareRoot","visible":"hide"},{"value":"True","type":"booleanTrue","visible":"show"},{"value":"False","type":"booleanFalse","visible":"show"},{"value":this.commaSeparator,"action":"char","type":"numberCommaDecimal","visible":"hide"},{"value":" ","type":"num0","action":"char","visible":"hide"},{"value":this.periodSeparator,"action":"char","type":"decimalPeriodNumber","visible":"hide"},{"value":"=","action":"char","type":"equalsSign"},{"value":"﬩","action":"char","type":"additionOpHebrew","visible":"hide"},{"value":"+","action":"char","type":"additionOp","visible":"hide"}
              ]}
            ];
            this.baseUIRendering();
            this.populateUINumberLayout();
  ...
  computeResults() {
    ...
    switch(this.operatorXY) {
      ...
      case '⊻' :
        ...
        break;
      case '≤' :
        this.booleanResult = numberOperandX <= numberOperandY;
        break;
      case '≥' :
        this.booleanResult = numberOperandX >= numberOperandY;
        break;
    ...
    this.nonUnicodeEquationAndResult();
    if (this.currentBase == "base2") {
      if (this.operatorXY == '&' || this.operatorXY == '!' || this.operatorXY == "<<" || this.operatorXY == ">>" || this.operatorXY == "⊻")
        this.resultField.nativeElement.value = this.operationResult;
      else if (this.operatorXY == '≤' || this.operatorXY == '≥') 
        this.resultField.nativeElement.value = this.booleanResult;
    } else {
      this.resultField.nativeElement.value = this.displayVariableInLocaleFormat(this.operationResult);
    }  
    this.equationField.nativeElement.value = this.equationField.nativeElement.value + " = " + this.resultField.nativeElement.value;
