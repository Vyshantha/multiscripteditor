...
export class CustomiseKeyboardsComponent implements OnInit {
  ...
  displayComputedResultForUnicodeScript : any = ['adlm','ahom','aima','am','avst','bhai','bopo','brah','cans','chrs','copt','el','ett','geez','glag','gong','gonm','gup','hmng','hmnp','hy','ion','ital','iub','ja','kaid','kali','kan','khar','khud','kult','latf','leke','maya','mend','mero','modi','mon','moss','mroo','my','nbat','nkoo','rohg','runr','takr','ti','tig','txg','wara','zhcn','zhtw','zih'];

  //Separation between Numerals for Display - https://en.wikipedia.org/wiki/Decimal_separator#Usage_worldwide

  // COMMA ,
  commaDecimalSeparatorLocales: any = ['ab','af','an','apu','ast','az','aze','bak','bar','be','befr','bg','br','bs','bsla','ca','cdd','co','cs','csb','da','de','el','elba','eo','es','et','eu','eurkey','evncy','evnla','fi','fo','fr','frca','fy','gag','gall','gl','gn','goth','gor','hil','hu','hv','hy','id','ilo','is','it','ka','kaz','kca','kha','kir','kk','kl','komi','ky','latf','lb','lfn','li','lij','liv','lld','lmo','lt','ltg','lv','mad','masu','mk','mn','mnla','mns','mon','mwl','nl','no','nso','pam','pl','pt','ptbr','ro','ru','sk','sl','sq','sr','ss','st','sv','tk','tn','tr','ts','tuk','uk','uz','uzb','ven','vi','xh','zu'];
  thousandsPositionPeriodAndCommaDecimal : any = ['apu','ban','bar','bjn','bs','bsla','bug','bugla','co','da','de','el','eurkey','fo','fy','gor','hil','id','ilo','it','kl','latf','lb','mad','mk','mn','mnla','nl','nld','pam','ptbr','ro','sgnw','sl','tr','vi'];
  thousandsPositionSpaceAndCommaDecimal : any = ['af','an','asom','ast','az','aze','bak','be','befr','bg','br','ca','cans','cari','carr','cdd','cs','csb','elba','eo','es','et','eu','evncy','evnla','fi','fr','frca','gag','gall','gl','goth','hr','hu','ka','kaz','kca','kha','kk','komi','ky','la','lfn','lld','lmo','li','lij','liv','lt','ltg','lv','masu','mns','mwl','no','nusk','pl','pt','ru','sk','sq','sr','sv','uk'];
  thousandsPositionApostropheAndCommaDecimal : any = ['gsw'];
  commaAndPeriodAlternating: any = ['hr'];

  // PERIOD .
  periodDecimalSeparatorLocales: any = ['ace','adin','adlm','ahom','aima','ajam','ak','am','ang','as','asom','avo','ay','bada','bali','bamu','ban','bcl','bhai','bharati','bhat','bin','bis','bjn','bjyo','bla','bm','bn','bopo','brah','brx','brxla','bug','bugla','bya','cakm','cans','cari','carr','ceb','ch','cham','cher','cjk','cree','crew','dag','dgabf','dgagh','dham','dhan','diak','din','dv','dz','ee','en','engb','enin','enintl','enus','esmx','esy','ff','fj','fon','fur','ga','gd','gil','gong','gonm','goyk','gran','gsw','gu','gup','gv','ha','haj','hatr','haw','he','hi','hmn','hmng','hmnp','ht','iai','ics','ig','iku','indus','iu','iub','ja','jam','jv','kaid','kali','kan','kawi','kbp','khar','khud','ki','km','kn','ko','kon','kpe','kri','kru','kthi','ku','kw','maga','maha','mai','lad','ladla','lbj','leke','lepc','lepo','lg','limb','ln','lo','loma','luo','lus','lwo','lyci','lydi','malt','mamb','mani','mand','marc','mfe','mic','mguj','moon','mos','mni','mend','mg','mh','mi','min','ml','mnc','mnk','modi','moss','mr','mroo','mrw','ms','mt','my','nbat','ne','ngyo','njo','nkoo','odu','plrd','rn','rohg','rw','sa','sgnw','si','suz','ta','takr','tfng','th','thaa','tiga','ussign','vah','vatt','wara','yo','zag','zhcn','zhtw','zih'];
  desiLakhCommaDecimalPeriodPosition: any = ['as','bada','bcl','bharati','bn','brah','brx','brxla','bya','cakm','dham','dhan','diak','dv','dz','enin','gong','gonm','goyk','gran','gu','gup','haj','hi','indus','khud','kn','kru','kthi','lbj','lus','maga','maha','mai','malt','mfe','mguj','ml','mni','modi','moss','mr','mroo','ne','rohg','sa','si','ta','takr','te','th','thaa','tiga','vatt','wara','ur'];
  desiLakhSpaceDecimalPeriodPosition: any = ['bhai','bhat','enin','lepc','limb','ne','suz'];
  thousandsPositionCommaAndPeriodDecimal : any = ['ab','ace','adin','adlm','ajam','ak','ang','ay','bali','bamu','bin','bis','bla','bm','ceb','ch','cham','cher','cjk','cree','crew','dag','dgabf','dgagh','din','ee','en','engb','enintl','enus','esmx','esy','fa','ff','fj','fon','fur','ga','gd','gil','gn','gv','ha','hatr','haw','he','hmn','hmng','hmnp','ht','iai','ics','ig','iku','iu','iub','is','ja','jam','jv','kawi','kbp','ki','km','ko','kon','kpe','kri','ku','kw','mg','mh','min','lad','ladla','lepo','lg','ln','lo','loma','luo','lwo','lyci','lydi','mamb','mand','mani','mend','mi','mic','mnk','moon','mos','mrw','ms','mt','njo','nkoo','odu','rn','rw','tfng','th','ussign','vah','zag','zhtw'];
  tenThousandsCommaAndPeriod: any = ['kaid','kan','zhcn','zih'];
  tenThousandsSpaceAndPeriod: any = ['bopo','ja','plrd','zhtw'];
  thousandsPositionSpaceAndPeriodDecimal : any = ['marc','mnc'];
  thousandsPositionApostropheAndPeriodDecimal : any = ['gsw'];

  // ARABIC SEPARATOR ٬
  arabicDecimalSeparatorLocales: any = ['ar','arc','ary','bal','bsk','chrs','ckb','elym','fa','he','jawi','khat','ks','lad','mnkar','ps','rhg','sd','ur','yi'];
  ...
  //Remove Images folders ['ari','diak','nagm','ndju','pall','ranj','tiga','vatt','vith','zag']
