...
export class CustomiseKeyboardsComponent implements OnInit {
  ...
  alphaNumeric: any = ['arc','asom','el','glag','goth','he','hy','ion','ka','lad','linb','linea','mand','nusk','syrc','udi','yi'];
  ...
  use10InPlaceOfZero: any = ['am','ary','avst','chrs','copt','el','esy','ett','geez','glag','he','hy','hung','ion','ital','ka','khar','kult','la','lad','linb','linea','mero','nbat','pal','palm','phn','psal','runr','sgnw','ti','tig','txg','udi','xpr','yi'];
  // Non-Decimal numerals
  nonStandardNumeral : any = ['chrs','ett','ital','hung','khar','kmt','kult','la','nbat','pal','palm','phn','psal','xpr'];
  // Base 20 numerals
  ...
  displayComputedResultForUnicodeScript : any = ['adlm','ahom','aima','am','ari','avst','bhai','bopo','brah','cans','chrs','copt','el','ett','geez','glag','gong','gonm','gup','hmng','hmnp','hung','hy','ion','ital','iub','ja','kaid','kali','kan','khar','khud','kult','latf','leke','maya','mend','mero','modi','mon','moss','mroo','my','nagm','newa','nbat','nkoo','osma','pal','palm','phn','psal','rohg','runr','takr','ti','tig','txg','wara','wcho','udi','xpr','zhcn','zhtw','zih'];

  //Separation between Numerals for Display - https://en.wikipedia.org/wiki/Decimal_separator#Usage_worldwide

  // COMMA ,
  commaDecimalSeparatorLocales: any = ['ab','af','an','apu','ast','az','aze','bak','ban','bar','be','befr','bg','br','bs','bsla','ca','cdd','co','cs','csb','da','de','el','elba','eo','es','et','eu','eurkey','evncy','evnla','fi','fo','fr','frca','fy','gag','gall','gl','gn','goth','gor','hil','hu','hv','hy','id','ilo','is','it','kaa','ka','kaz','kca','kha','kir','kk','kl','komi','ky','latf','lb','lfn','li','lij','liv','lld','lmo','lt','ltg','lv','mad','masu','mk','mn','mnla','mns','mon','mwl','nap','nia','nl','no','nrf','nso','oc','pag','pam','pap','pms','pl','pt','ptbr','ro','rom','ru','sah','sk','sl','sq','sr','ss','st','sv','tk','tn','tr','ts','tuk','uby','udi','uk','uz','uzb','vec','ven','vi','vith','wa','war','wym','xh','zza','zu'];
  thousandsPositionPeriodAndCommaDecimal : any = ['apu','ban','bar','bjn','bs','bsla','bug','bugla','co','da','de','el','eurkey','fo','fy','gor','hil','id','ilo','it','kl','latf','lb','mad','mk','mn','mnla','nap','nia','nl','nld','nrf','pag','pam','pap','pms','ptbr','ro','rom','sgnw','sl','tr','vi','war','xh','zza','zu'];
  thousandsPositionSpaceAndCommaDecimal : any = ['af','an','asom','ast','az','aze','bak','be','befr','bg','br','ca','cans','cari','carr','cdd','cs','csb','elba','eo','es','et','eu','evncy','evnla','fi','fr','frca','gag','gall','gl','goth','hr','hu','kaa','ka','kaz','kca','kha','kk','komi','ky','la','lfn','lld','lmo','li','lij','liv','lt','ltg','lv','masu','mns','mwl','no','nusk','oc','pl','pt','ru','sah','sk','sq','sr','sv','uby','uz','uzb','uk','vec','ven','vith','wa','wym'];
  thousandsPositionApostropheAndCommaDecimal : any = ['gsw'];
  commaAndPeriodAlternating: any = ['hr'];

  // PERIOD .
  periodDecimalSeparatorLocales: any = ['aa','ace','adin','adlm','ahom','aima','ajam','ak','am','ang','ari','as','asom','avo','ay','bada','bali','bamu','bcl','bhai','bharati','bhat','bin','bis','bjn','bjyo','bla','bm','bn','bopo','brah','brx','brxla','bug','bugla','bya','cakm','cans','cari','carr','ceb','ch','cham','cher','cjk','cree','crew','cy','dag','dgabf','dgagh','dham','dhan','diak','din','dv','dz','ee','en','engb','enin','enintl','enus','esmx','esy','fa','ff','fj','fon','fur','ga','gd','gil','gong','gonm','goyk','gran','gsw','gu','gup','gv','ha','haj','hatr','haw','he','hi','hmn','hmng','hmnp','ht','iai','ics','ig','iku','indus','iu','iub','ja','jiag','jam','jpn','jv','kaid','kali','kan','kawi','kbp','khar','khud','ki','km','kn','ko','kon','kpe','kri','kru','kthi','ku','kw','maga','maha','mai','lad','ladla','lbj','leke','lepc','lepo','lg','limb','ln','lo','loma','luo','lus','lwo','lyci','lydi','malt','mamb','mani','mand','marc','mfe','mic','mguj','moon','mos','mni','mend','mg','mh','mi','min','ml','mnc','mnk','modi','moss','mr','mroo','mrw','ms','mt','my','na','nag','nagm','nand','nask','newa','nbat','nde','ne','ngyo','njo','njz','nkoo','nshu','nv','ny','odu','oji','om','onw','olck','or','pa','pau','phyg','pice','pin','pli','pln','plrd','qu','ranj','rally','rap','rn','rohg','rw','sa','sgnw','si','suz','ta','takr','tfng','th','thaa','tiga','ussign','vah','vatt','wara','wbl','wcho','wo','wolf','ug','umw','ur','usy','uyy','vaii','xpu','yiii','yo','zag','zhcn','zhtw','zih','zou'];
  desiLakhCommaDecimalPeriodPosition: any = ['as','bada','bcl','bharati','bn','brah','brx','brxla','bya','cakm','dham','dhan','diak','dv','dz','enin','gong','gonm','goyk','gran','gu','gup','haj','hi','indus','khud','kn','kru','kthi','lbj','lus','maga','maha','mai','malt','mfe','mguj','ml','mni','modi','moss','mr','mroo','nag','nagm','nand','ne','newa','njz','olck','or','pa','pli','ranj','rohg','sa','si','ta','takr','te','th','thaa','tiga','vatt','wara','ur','wcho','zou'];
  desiLakhSpaceDecimalPeriodPosition: any = ['bhai','bhat','enin','lepc','limb','ne','suz'];
  thousandsPositionCommaAndPeriodDecimal : any = ['aa','ab','ace','adin','adlm','ajam','ak','ang','ay','bali','bamu','bin','bis','bjyo','bla','bm','ceb','ch','cham','cher','cjk','cree','crew','cy','dag','dgabf','dgagh','din','ee','en','engb','enintl','enus','esmx','esy','fa','ff','fj','fon','fur','ga','gd','gil','gn','gv','ha','hatr','haw','he','hmn','hmng','hmnp','ht','iai','ics','ig','iku','iu','iub','is','ja','jam','jpn','jv','kawi','kbp','ki','km','ko','kon','kpe','kri','ku','kw','mg','mh','min','lad','ladla','lepo','lg','ln','lo','loma','luo','lwo','lyci','lydi','mamb','mand','mani','mend','mi','mic','mnk','moon','mos','mrw','ms','mt','na','nask','nde','ngyo','njo','nkoo','nv','ny','odu','oji','om','onw','pau','phyg','pice','pln','qu','rally','rap','rn','rw','tfng','th','ussign','vah','wbl','wo','wolf','xpu','ug','umw','usy','uyy','vaii','yo','zag','zhtw'];
  tenThousandsCommaAndPeriod: any = ['kaid','kan','pin','zhcn','zih'];
  tenThousandsSpaceAndPeriod: any = ['bopo','ja','jiag','plrd','nshu','yiii','zhtw'];
  thousandsPositionSpaceAndPeriodDecimal : any = ['marc','mnc'];
  thousandsPositionApostropheAndPeriodDecimal : any = ['gsw'];

  // ARABIC SEPARATOR ٬
  arabicDecimalSeparatorLocales: any = ['ar','arc','arold','ary','bal','bsk','chrs','ckb','elym','he','jawi','khat','ks','lad','mnkar','orkh','osma','ps','rhg','sd','woal','yi'];
  ...
  rtlNumerals : string [] = ['adlm','avst','chrs','ett','he','hung','khar','kult','lad','linb','linea','mend','mero','nbat','nkoo','odu','pal','palm','phn','psal','sog','wolf','xpr','yi'];
  ...
  layoutRotatedScript: string[] = ['aztc','bla','cree','dite','evn','galk','geez','hira','iba','inuk','kata','maya','mnc','mon','ndju','ogam','oira','phag','vaii'];
  ...
  /* TODO Items
    ...
    - Special Case for display & computing - use10InPlaceOfZero/alphaNumeric/numberFor10Powers/nonStandardNumeral/sexagesimal 
